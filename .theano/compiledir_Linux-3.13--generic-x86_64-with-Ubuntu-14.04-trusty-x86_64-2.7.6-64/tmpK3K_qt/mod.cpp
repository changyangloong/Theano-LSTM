...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e() {}
        ~__struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e_executor(__struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e* self) {
            return self->run();
        }

        static void __struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e* struct_ptr = new __struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e_executor), struct_ptr, __struct_compiled_op_f9985618acf86f1b3bd8dd843eaaa00e_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf9985618acf86f1b3bd8dd843eaaa00e(void){
   import_array();
   (void) Py_InitModule("f9985618acf86f1b3bd8dd843eaaa00e", MyMethods);
}
