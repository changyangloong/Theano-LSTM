...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69() {}
        ~__struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69_executor(__struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69* self) {
            return self->run();
        }

        static void __struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69* struct_ptr = new __struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69_executor), struct_ptr, __struct_compiled_op_bd82f0be45edd1648bbcc335a0f36a69_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbd82f0be45edd1648bbcc335a0f36a69(void){
   import_array();
   (void) Py_InitModule("bd82f0be45edd1648bbcc335a0f36a69", MyMethods);
}
