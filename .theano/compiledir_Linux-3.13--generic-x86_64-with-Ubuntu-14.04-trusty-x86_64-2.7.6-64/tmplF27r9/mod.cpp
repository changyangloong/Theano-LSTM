...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bfee00198b1c96859ad530d2077bdad8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bfee00198b1c96859ad530d2077bdad8() {}
        ~__struct_compiled_op_bfee00198b1c96859ad530d2077bdad8(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bfee00198b1c96859ad530d2077bdad8_executor(__struct_compiled_op_bfee00198b1c96859ad530d2077bdad8* self) {
            return self->run();
        }

        static void __struct_compiled_op_bfee00198b1c96859ad530d2077bdad8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bfee00198b1c96859ad530d2077bdad8*)self);
        }
...
PyMODINIT_FUNC initbfee00198b1c96859ad530d2077bdad8(void){
   import_array();
   (void) Py_InitModule("bfee00198b1c96859ad530d2077bdad8", MyMethods);
}
