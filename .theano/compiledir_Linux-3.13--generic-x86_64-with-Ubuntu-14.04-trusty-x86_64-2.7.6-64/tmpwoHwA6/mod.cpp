...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19() {}
        ~__struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19(void) {
            cleanup();
        }
...
npy_float32 &V1_i = * ( V1_iter+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);
            ...
            
        {
            ...
            V1_i = V3_i * V5_i * V7_i * V9_i * V11_i * V13_i * V7_i;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19_executor(__struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19* self) {
            return self->run();
        }

        static void __struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19* struct_ptr = new __struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19_executor), struct_ptr, __struct_compiled_op_e9fd37d6e9f390e5c0fb31c317d10e19_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite9fd37d6e9f390e5c0fb31c317d10e19(void){
   import_array();
   (void) Py_InitModule("e9fd37d6e9f390e5c0fb31c317d10e19", MyMethods);
}
