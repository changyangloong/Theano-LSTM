...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe() {}
        ~__struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe(void) {
            cleanup();
        }
...
dims[1] = V3_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V15) && PyArray_ISFORTRAN(V17));
        }
        else {
...
V19_tmp1 = V17_i * V15_i;
npy_float32 V19_tmp2;
V19_tmp2 = V5_i * V17_i * V7_i;
npy_float32 V19_tmp3;
V19_tmp3 = V15_i * V9_i * V11_i * V13_i * V7_i;
npy_float32 V19_tmp4;
V19_tmp4 = V5_i * V7_i * V9_i * V11_i * V13_i * V7_i;
V1_i = V3_i + V19_tmp4 + V19_tmp3 + V19_tmp2 + V19_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe_executor(__struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe* self) {
            return self->run();
        }

        static void __struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe* struct_ptr = new __struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe_executor), struct_ptr, __struct_compiled_op_d82fcf4c63ae6141ff0987e0f4941ffe_destructor);
  return thunk; }
...
PyMODINIT_FUNC initd82fcf4c63ae6141ff0987e0f4941ffe(void){
   import_array();
   (void) Py_InitModule("d82fcf4c63ae6141ff0987e0f4941ffe", MyMethods);
}
