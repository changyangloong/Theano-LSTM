...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_11afa83ab4a462147920fe558d75efa8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_11afa83ab4a462147920fe558d75efa8() {}
        ~__struct_compiled_op_11afa83ab4a462147920fe558d75efa8(void) {
            cleanup();
        }
...
dims[1] = V3_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V15));
        }
        else {
...
npy_float32 &V1_i = * ( V1_iter+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);
            ...
            
        {
            ...
            V1_i = V3_i * V5_i * V7_i * V9_i * V11_i * V13_i * V15_i * V9_i;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_11afa83ab4a462147920fe558d75efa8_executor(__struct_compiled_op_11afa83ab4a462147920fe558d75efa8* self) {
            return self->run();
        }

        static void __struct_compiled_op_11afa83ab4a462147920fe558d75efa8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_11afa83ab4a462147920fe558d75efa8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_11afa83ab4a462147920fe558d75efa8* struct_ptr = new __struct_compiled_op_11afa83ab4a462147920fe558d75efa8();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_11afa83ab4a462147920fe558d75efa8_executor), struct_ptr, __struct_compiled_op_11afa83ab4a462147920fe558d75efa8_destructor);
  return thunk; }
...
PyMODINIT_FUNC init11afa83ab4a462147920fe558d75efa8(void){
   import_array();
   (void) Py_InitModule("11afa83ab4a462147920fe558d75efa8", MyMethods);
}
