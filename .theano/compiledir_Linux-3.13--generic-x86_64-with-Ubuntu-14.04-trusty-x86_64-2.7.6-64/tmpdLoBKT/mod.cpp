...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_79a59bf161fd38c1530de967bba4362c {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_79a59bf161fd38c1530de967bba4362c() {}
        ~__struct_compiled_op_79a59bf161fd38c1530de967bba4362c(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_79a59bf161fd38c1530de967bba4362c_executor(__struct_compiled_op_79a59bf161fd38c1530de967bba4362c* self) {
            return self->run();
        }

        static void __struct_compiled_op_79a59bf161fd38c1530de967bba4362c_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_79a59bf161fd38c1530de967bba4362c*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_79a59bf161fd38c1530de967bba4362c* struct_ptr = new __struct_compiled_op_79a59bf161fd38c1530de967bba4362c();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_79a59bf161fd38c1530de967bba4362c_executor), struct_ptr, __struct_compiled_op_79a59bf161fd38c1530de967bba4362c_destructor);
  return thunk; }
...
PyMODINIT_FUNC init79a59bf161fd38c1530de967bba4362c(void){
   import_array();
   (void) Py_InitModule("79a59bf161fd38c1530de967bba4362c", MyMethods);
}
