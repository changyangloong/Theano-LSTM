...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915() {}
        ~__struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915(void) {
            cleanup();
        }
...
npy_float32 &V11_i = * ( V11_iter+V11_stride_l1*ITER_1+V11_stride_l0*ITER_0);
        ...
        {
            #define V1_i V3_i
            V1_i = V3_i * V5_i * V7_i * V9_i * V11_i;
            #undef V1_i
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915_executor(__struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915* self) {
            return self->run();
        }

        static void __struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915* struct_ptr = new __struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915_executor), struct_ptr, __struct_compiled_op_54d792c0e5a5fb542949e1af3a2a3915_destructor);
  return thunk; }
...
PyMODINIT_FUNC init54d792c0e5a5fb542949e1af3a2a3915(void){
   import_array();
   (void) Py_InitModule("54d792c0e5a5fb542949e1af3a2a3915", MyMethods);
}
