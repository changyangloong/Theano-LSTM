...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6() {}
        ~__struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6(void) {
            cleanup();
        }
...
V15_0_tmp1 = ((V9_i)<(V7_i)? (V9_i): ((V7_i)<=(V9_i)? (V7_i): nan("")));
V15_tmp1 = V3_i ? V5_i : V15_0_tmp1;
}
...
npy_int8 V15_1_tmp2;
V15_1_tmp2 = (V15_tmp1 < V5_i);
V15_tmp2 = V15_1_tmp2 ? V15_1_tmp1 : V15_tmp1;
}

npy_int64 V15_tmp3;
{
npy_int8 V15_2_tmp1;
V15_2_tmp1 = (V15_tmp2 < V5_i);
V15_tmp3 = V15_2_tmp1 ? V5_i : V15_tmp2;
}
...
{
npy_int8 V15_4_tmp1;
V15_4_tmp1 = (V15_tmp4 < V5_i);
V15_tmp5 = V15_4_tmp1 ? V5_i : V15_tmp4;
}

npy_int8 V15_tmp6;
V15_tmp6 = (V15_tmp5 < V13_i);
V1_i = V15_tmp6 ? V15_tmp5 : V13_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6_executor(__struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6* self) {
            return self->run();
        }

        static void __struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6* struct_ptr = new __struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6_executor), struct_ptr, __struct_compiled_op_416340b9b17e664b675c6dfe2a9672f6_destructor);
  return thunk; }
...
PyMODINIT_FUNC init416340b9b17e664b675c6dfe2a9672f6(void){
   import_array();
   (void) Py_InitModule("416340b9b17e664b675c6dfe2a9672f6", MyMethods);
}
