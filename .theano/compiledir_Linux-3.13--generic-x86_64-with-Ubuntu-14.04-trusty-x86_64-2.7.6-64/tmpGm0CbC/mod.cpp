...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944() {}
        ~__struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944(void) {
            cleanup();
        }
...
V13_tmp4 = V13_tmp2 / V7_i;
npy_float32 V13_tmp5;
V13_tmp5 = (npy_float32)V13_tmp3;
npy_float32 V13_tmp6;
V13_tmp6 = V13_tmp1 * V13_tmp5;
V1_i = V3_i ? V13_tmp6 : V13_tmp4;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944_executor(__struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944* self) {
            return self->run();
        }

        static void __struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944* struct_ptr = new __struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944_executor), struct_ptr, __struct_compiled_op_840304a306d1fa3e5350ed7fe0b77944_destructor);
  return thunk; }
...
PyMODINIT_FUNC init840304a306d1fa3e5350ed7fe0b77944(void){
   import_array();
   (void) Py_InitModule("840304a306d1fa3e5350ed7fe0b77944", MyMethods);
}
