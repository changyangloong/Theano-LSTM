...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_199cda334426fd2692efece6566adfea {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_199cda334426fd2692efece6566adfea() {}
        ~__struct_compiled_op_199cda334426fd2692efece6566adfea(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_199cda334426fd2692efece6566adfea_executor(__struct_compiled_op_199cda334426fd2692efece6566adfea* self) {
            return self->run();
        }

        static void __struct_compiled_op_199cda334426fd2692efece6566adfea_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_199cda334426fd2692efece6566adfea*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_199cda334426fd2692efece6566adfea* struct_ptr = new __struct_compiled_op_199cda334426fd2692efece6566adfea();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_199cda334426fd2692efece6566adfea_executor), struct_ptr, __struct_compiled_op_199cda334426fd2692efece6566adfea_destructor);
  return thunk; }
...
PyMODINIT_FUNC init199cda334426fd2692efece6566adfea(void){
   import_array();
   (void) Py_InitModule("199cda334426fd2692efece6566adfea", MyMethods);
}
