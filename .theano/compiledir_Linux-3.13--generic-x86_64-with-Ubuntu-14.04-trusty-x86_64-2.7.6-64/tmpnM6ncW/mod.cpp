...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_be552cd075ea1ec2769fd3aecead2978 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_be552cd075ea1ec2769fd3aecead2978() {}
        ~__struct_compiled_op_be552cd075ea1ec2769fd3aecead2978(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_be552cd075ea1ec2769fd3aecead2978_executor(__struct_compiled_op_be552cd075ea1ec2769fd3aecead2978* self) {
            return self->run();
        }

        static void __struct_compiled_op_be552cd075ea1ec2769fd3aecead2978_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_be552cd075ea1ec2769fd3aecead2978*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_be552cd075ea1ec2769fd3aecead2978* struct_ptr = new __struct_compiled_op_be552cd075ea1ec2769fd3aecead2978();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_be552cd075ea1ec2769fd3aecead2978_executor), struct_ptr, __struct_compiled_op_be552cd075ea1ec2769fd3aecead2978_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbe552cd075ea1ec2769fd3aecead2978(void){
   import_array();
   (void) Py_InitModule("be552cd075ea1ec2769fd3aecead2978", MyMethods);
}
