...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8() {}
        ~__struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8_executor(__struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8* self) {
            return self->run();
        }

        static void __struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8* struct_ptr = new __struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8_executor), struct_ptr, __struct_compiled_op_0a145c984e030d9e8abd5f2c97ab85e8_destructor);
  return thunk; }
...
PyMODINIT_FUNC init0a145c984e030d9e8abd5f2c97ab85e8(void){
   import_array();
   (void) Py_InitModule("0a145c984e030d9e8abd5f2c97ab85e8", MyMethods);
}
