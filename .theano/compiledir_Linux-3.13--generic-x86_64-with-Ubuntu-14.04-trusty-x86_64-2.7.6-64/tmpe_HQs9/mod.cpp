...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271() {}
        ~__struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271(void) {
            cleanup();
        }
...
{
npy_int64 V17_1_0_tmp1;
V17_1_0_tmp1 = V5_i + V9_i + V3_i;
npy_int8 V17_1_0_tmp2;
V17_1_0_tmp2 = (V5_i < V7_i);
V17_1_tmp1 = V17_1_0_tmp2 ? V17_1_0_tmp1 : V5_i;
}

npy_int64 V17_1_tmp2;
V17_1_tmp2 = V13_i - V9_i;
npy_int64 V17_1_tmp3;
{
npy_int8 V17_1_2_tmp1;
V17_1_2_tmp1 = (V17_1_tmp1 < V7_i);
V17_1_tmp3 = V17_1_2_tmp1 ? V11_i : V17_1_tmp1;
}

npy_int8 V17_1_tmp4;
V17_1_tmp4 = (V17_1_tmp3 >= V13_i);
V17_tmp2 = V17_1_tmp4 ? V17_1_tmp2 : V17_1_tmp3;
}

npy_int64 V17_tmp3;
{
npy_int64 V17_2_tmp1;
V17_2_tmp1 = V15_i + V9_i + V3_i;
npy_int8 V17_2_tmp2;
V17_2_tmp2 = (V15_i < V7_i);
V17_tmp3 = V17_2_tmp2 ? V17_2_tmp1 : V15_i;
}

npy_int64 V17_tmp4;
V17_tmp4 = V17_tmp1 ? V9_i : V13_i;
npy_int64 V17_tmp5;
V17_tmp5 = V17_tmp2 + V9_i;
npy_int64 V17_tmp6;
{
npy_int8 V17_5_tmp1;
V17_5_tmp1 = (V17_tmp3 < V7_i);
V17_tmp6 = V17_5_tmp1 ? V11_i : V17_tmp3;
}

npy_int64 V17_tmp7;
V17_tmp7 = V3_i - V17_tmp4;
npy_int64 V17_tmp8;
{
npy_int8 V17_7_tmp1;
V17_7_tmp1 = (V17_tmp5 < V7_i);
V17_tmp8 = V17_7_tmp1 ? V7_i : V17_tmp5;
}

npy_int64 V17_tmp9;
{
npy_int8 V17_8_tmp1;
V17_8_tmp1 = (V17_tmp6 >= V13_i);
npy_int64 V17_8_tmp2;
V17_8_tmp2 = V17_8_tmp1 ? V13_i : V17_tmp6;
npy_int64 V17_8_tmp3;
V17_8_tmp3 = V17_tmp2 - V17_8_tmp2;
npy_int64 V17_8_tmp4;
V17_8_tmp4 = V17_8_tmp3 - V9_i;
npy_int64 V17_8_tmp5;

if (V17_8_tmp4 < 0) {
    if (V9_i < 0) {
        V17_8_tmp5 = ((-V17_8_tmp4) / (-V9_i));
    } else {
        V17_8_tmp5 = - ((-V17_8_tmp4) / V9_i) - ((THEANO_MACRO_MOD((-V17_8_tmp4), V9_i) == 0) ? 0 : 1);
    }
} else {
    if (V9_i < 0) {
        V17_8_tmp5 = - (V17_8_tmp4 / (-V9_i)) - ((THEANO_MACRO_MOD(V17_8_tmp4, (-V9_i)) == 0) ? 0 : 1);
...
V17_tmp9 = V17_8_tmp5 + V9_i;
}

npy_int64 V17_tmp10;
V17_tmp10 = V17_tmp7 + V9_i;
npy_int64 V17_tmp11;
{
npy_int8 V17_10_tmp1;
V17_10_tmp1 = (V17_tmp9 < V7_i);
npy_int64 V17_10_tmp2;
V17_10_tmp2 = V17_10_tmp1 ? V7_i : V17_tmp9;
npy_int64 V17_10_tmp3;
V17_10_tmp3 = V17_10_tmp2 - V9_i;
npy_int64 V17_10_tmp4;
V17_10_tmp4 = V17_tmp5 - V17_10_tmp3;
V17_tmp11 = V17_10_tmp4 - V9_i;
}

npy_int64 V17_tmp12;
V17_tmp12 = ((V9_i)>(V17_tmp10)? (V9_i): ((V17_tmp10)>=(V9_i)? (V17_tmp10): nan("")));
npy_int64 V17_tmp13;
{
npy_int64 V17_12_tmp1;
V17_12_tmp1 = V17_tmp5 - V9_i;
npy_int8 V17_12_tmp2;
V17_12_tmp2 = (V17_tmp11 < V7_i);
V17_tmp13 = V17_12_tmp2 ? V17_12_tmp1 : V17_tmp11;
}

npy_int64 V17_tmp14;
{
npy_int8 V17_13_tmp1;
V17_13_tmp1 = (V17_tmp13 < V7_i);
V17_tmp14 = V17_13_tmp1 ? V7_i : V17_tmp13;
}

npy_int8 V17_tmp15;
V17_tmp15 = (V17_tmp14 < V17_tmp8);
npy_int64 V17_tmp16;
V17_tmp16 = V17_tmp15 ? V17_tmp14 : V17_tmp8;
npy_int64 V17_tmp17;
V17_tmp17 = V3_i - V17_tmp16;
npy_int64 V17_tmp18;
V17_tmp18 = V17_tmp17 + V9_i;
npy_int64 V17_tmp19;
V17_tmp19 = ((V9_i)>(V17_tmp18)? (V9_i): ((V17_tmp18)>=(V9_i)? (V17_tmp18): nan("")));
V1_i = ((V17_tmp12)>(V17_tmp19)? (V17_tmp12): ((V17_tmp19)>=(V17_tmp12)? (V17_tmp19): nan("")));
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271_executor(__struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271* self) {
            return self->run();
        }

        static void __struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271* struct_ptr = new __struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271_executor), struct_ptr, __struct_compiled_op_f931ec4884db06ab05c0ea9e7bfea271_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf931ec4884db06ab05c0ea9e7bfea271(void){
   import_array();
   (void) Py_InitModule("f931ec4884db06ab05c0ea9e7bfea271", MyMethods);
}
