...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291() {}
        ~__struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291(void) {
            cleanup();
        }
...
V19_0_tmp1 = V9_i - V11_i;
V19_tmp1 = V7_i + V19_0_tmp1;
}
...
V19_tmp4 = (V3_i <= V5_i);
npy_int64 V19_tmp5;
V19_tmp5 = ((V17_i)<(V19_tmp1)? (V17_i): ((V19_tmp1)<=(V17_i)? (V19_tmp1): nan("")));
npy_int8 V19_tmp6;
V19_tmp6 = (V19_tmp1 < V5_i);
npy_int64 V19_tmp7;
V19_tmp7 = -V19_tmp2;
npy_int8 V19_tmp8;
V19_tmp8 = (V19_tmp6 & V19_tmp3);
npy_int64 V19_tmp9;
V19_tmp9 = V19_tmp7 - V11_i;
npy_int64 V19_tmp10;
V19_tmp10 = V19_tmp8 ? V19_tmp9 : V19_tmp5;
V1_i = V19_tmp4 ? V5_i : V19_tmp10;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291_executor(__struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291* self) {
            return self->run();
        }

        static void __struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291* struct_ptr = new __struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291_executor), struct_ptr, __struct_compiled_op_6d4af5653dd3dea688fc09b40aaae291_destructor);
  return thunk; }
...
PyMODINIT_FUNC init6d4af5653dd3dea688fc09b40aaae291(void){
   import_array();
   (void) Py_InitModule("6d4af5653dd3dea688fc09b40aaae291", MyMethods);
}
