...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bd066010c467570a1db433bdf0e32f34 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bd066010c467570a1db433bdf0e32f34() {}
        ~__struct_compiled_op_bd066010c467570a1db433bdf0e32f34(void) {
            cleanup();
        }
...
V15_tmp2 = V15_1_tmp1 ? V13_i : V15_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bd066010c467570a1db433bdf0e32f34_executor(__struct_compiled_op_bd066010c467570a1db433bdf0e32f34* self) {
            return self->run();
        }

        static void __struct_compiled_op_bd066010c467570a1db433bdf0e32f34_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bd066010c467570a1db433bdf0e32f34*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bd066010c467570a1db433bdf0e32f34* struct_ptr = new __struct_compiled_op_bd066010c467570a1db433bdf0e32f34();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bd066010c467570a1db433bdf0e32f34_executor), struct_ptr, __struct_compiled_op_bd066010c467570a1db433bdf0e32f34_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbd066010c467570a1db433bdf0e32f34(void){
   import_array();
   (void) Py_InitModule("bd066010c467570a1db433bdf0e32f34", MyMethods);
}
