...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820() {}
        ~__struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820(void) {
            cleanup();
        }
                ...
                
    {
        ...
        if (!V1) {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(1, dims, NPY_INT32, 0);
            }
        }
        if (!V1) {
            {
        ...
        goto __label_5;}
                ...
                V1_stride0 = PyArray_STRIDES(V1)[0] / sizeof(npy_int32);
...
npy_int32 &V1_i = * ( V1_iter + ITER_0 * V1_jump0_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820_executor(__struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820* self) {
            return self->run();
        }

        static void __struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820* struct_ptr = new __struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820_executor), struct_ptr, __struct_compiled_op_55a17f0654b6c65f53d51bc3e4e07820_destructor);
  return thunk; }
...
PyMODINIT_FUNC init55a17f0654b6c65f53d51bc3e4e07820(void){
   import_array();
   (void) Py_InitModule("55a17f0654b6c65f53d51bc3e4e07820", MyMethods);
}
