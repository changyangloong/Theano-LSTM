...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7() {}
        ~__struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7_executor(__struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7* self) {
            return self->run();
        }

        static void __struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7* struct_ptr = new __struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7_executor), struct_ptr, __struct_compiled_op_5ddb56cab8f3a3448504da2d413d3af7_destructor);
  return thunk; }
...
PyMODINIT_FUNC init5ddb56cab8f3a3448504da2d413d3af7(void){
   import_array();
   (void) Py_InitModule("5ddb56cab8f3a3448504da2d413d3af7", MyMethods);
}
