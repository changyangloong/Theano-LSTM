...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_67d4f77836bae94552a17e0bef49fd51 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_67d4f77836bae94552a17e0bef49fd51() {}
        ~__struct_compiled_op_67d4f77836bae94552a17e0bef49fd51(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_67d4f77836bae94552a17e0bef49fd51_executor(__struct_compiled_op_67d4f77836bae94552a17e0bef49fd51* self) {
            return self->run();
        }

        static void __struct_compiled_op_67d4f77836bae94552a17e0bef49fd51_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_67d4f77836bae94552a17e0bef49fd51*)self);
        }
...
PyMODINIT_FUNC init67d4f77836bae94552a17e0bef49fd51(void){
   import_array();
   (void) Py_InitModule("67d4f77836bae94552a17e0bef49fd51", MyMethods);
}
