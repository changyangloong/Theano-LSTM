...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f34269811e626354f616e42bdcec04ab {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f34269811e626354f616e42bdcec04ab() {}
        ~__struct_compiled_op_f34269811e626354f616e42bdcec04ab(void) {
            cleanup();
        }
...
V21_0_tmp1 = V7_i + V9_i + V11_i;
npy_int8 V21_0_tmp2;
V21_0_tmp2 = (V3_i < V5_i);
V21_tmp1 = V21_0_tmp2 ? V21_0_tmp1 : V3_i;
}

npy_int64 V21_tmp2;
{
npy_int64 V21_1_tmp1;
V21_1_tmp1 = V7_i + V17_i + V11_i;
npy_int8 V21_1_tmp2;
V21_1_tmp2 = (V15_i < V5_i);
V21_tmp2 = V21_1_tmp2 ? V21_1_tmp1 : V15_i;
}

npy_int64 V21_tmp3;
{
npy_int8 V21_2_tmp1;
V21_2_tmp1 = (V21_tmp1 < V5_i);
V21_tmp3 = V21_2_tmp1 ? V13_i : V21_tmp1;
}

npy_int64 V21_tmp4;
{
npy_int8 V21_3_tmp1;
V21_3_tmp1 = (V21_tmp2 < V5_i);
V21_tmp4 = V21_3_tmp1 ? V5_i : V21_tmp2;
}

npy_int64 V21_tmp5;
{
npy_int8 V21_4_tmp1;
V21_4_tmp1 = (V21_tmp3 >= V7_i);
V21_tmp5 = V21_4_tmp1 ? V7_i : V21_tmp3;
}

npy_int64 V21_tmp6;
{
npy_int8 V21_5_tmp1;
V21_5_tmp1 = (V21_tmp4 >= V7_i);
V21_tmp6 = V21_5_tmp1 ? V7_i : V21_tmp4;
}

npy_int64 V21_tmp7;
{
npy_int8 V21_6_tmp1;
V21_6_tmp1 = (V21_tmp5 < V5_i);
V21_tmp7 = V21_6_tmp1 ? V5_i : V21_tmp5;
}

npy_int64 V21_tmp8;
{
npy_int8 V21_7_tmp1;
V21_7_tmp1 = (V21_tmp6 < V5_i);
V21_tmp8 = V21_7_tmp1 ? V5_i : V21_tmp6;
}

npy_int8 V21_tmp9;
V21_tmp9 = (V21_tmp8 < V21_tmp7);
npy_int64 V21_tmp10;
V21_tmp10 = V21_tmp9 ? V21_tmp8 : V21_tmp7;
npy_int64 V21_tmp11;
V21_tmp11 = V21_tmp7 - V21_tmp10;
V1_i = V21_tmp11 - V19_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f34269811e626354f616e42bdcec04ab_executor(__struct_compiled_op_f34269811e626354f616e42bdcec04ab* self) {
            return self->run();
        }

        static void __struct_compiled_op_f34269811e626354f616e42bdcec04ab_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f34269811e626354f616e42bdcec04ab*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f34269811e626354f616e42bdcec04ab* struct_ptr = new __struct_compiled_op_f34269811e626354f616e42bdcec04ab();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f34269811e626354f616e42bdcec04ab_executor), struct_ptr, __struct_compiled_op_f34269811e626354f616e42bdcec04ab_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf34269811e626354f616e42bdcec04ab(void){
   import_array();
   (void) Py_InitModule("f34269811e626354f616e42bdcec04ab", MyMethods);
}
