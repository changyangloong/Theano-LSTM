...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6() {}
        ~__struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6(void) {
            cleanup();
        }
...
{
npy_int8 V15_1_tmp1;
V15_1_tmp1 = (V15_tmp1 < V5_i);
V15_tmp2 = V15_1_tmp1 ? V5_i : V15_tmp1;
}

npy_int64 V15_tmp3;
{
npy_int8 V15_2_tmp1;
V15_2_tmp1 = (V15_tmp2 >= V7_i);
V15_tmp3 = V15_2_tmp1 ? V7_i : V15_tmp2;
}

npy_int64 V15_tmp4;
{
npy_int8 V15_3_tmp1;
V15_3_tmp1 = (V15_tmp3 < V5_i);
V15_tmp4 = V15_3_tmp1 ? V5_i : V15_tmp3;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6_executor(__struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6* self) {
            return self->run();
        }

        static void __struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6* struct_ptr = new __struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6_executor), struct_ptr, __struct_compiled_op_58f38067d6e2769da8dbbea3e24ad1b6_destructor);
  return thunk; }
...
PyMODINIT_FUNC init58f38067d6e2769da8dbbea3e24ad1b6(void){
   import_array();
   (void) Py_InitModule("58f38067d6e2769da8dbbea3e24ad1b6", MyMethods);
}
