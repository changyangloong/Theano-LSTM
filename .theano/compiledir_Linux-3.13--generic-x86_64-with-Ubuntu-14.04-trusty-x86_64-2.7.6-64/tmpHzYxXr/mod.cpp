...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8a96b2a705cdd71d66a4ae8b2c3bec26 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8a96b2a705cdd71d66a4ae8b2c3bec26() {}
        ~__struct_compiled_op_8a96b2a705cdd71d66a4ae8b2c3bec26(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8a96b2a705cdd71d66a4ae8b2c3bec26_executor(__struct_compiled_op_8a96b2a705cdd71d66a4ae8b2c3bec26* self) {
            return self->run();
        }

        static void __struct_compiled_op_8a96b2a705cdd71d66a4ae8b2c3bec26_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8a96b2a705cdd71d66a4ae8b2c3bec26*)self);
        }
...
PyMODINIT_FUNC init8a96b2a705cdd71d66a4ae8b2c3bec26(void){
   import_array();
   (void) Py_InitModule("8a96b2a705cdd71d66a4ae8b2c3bec26", MyMethods);
}
