...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718() {}
        ~__struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718_executor(__struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718* self) {
            return self->run();
        }

        static void __struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718* struct_ptr = new __struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718_executor), struct_ptr, __struct_compiled_op_e6b6a4a8814463dec3202dd20f9ee718_destructor);
  return thunk; }
...
PyMODINIT_FUNC inite6b6a4a8814463dec3202dd20f9ee718(void){
   import_array();
   (void) Py_InitModule("e6b6a4a8814463dec3202dd20f9ee718", MyMethods);
}
