...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5() {}
        ~__struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5(void) {
            cleanup();
        }
...
npy_int64& V1_i = *V1_iter;
                  ...
                  {
npy_int64 V13_tmp1;
V13_tmp1 = V5_i + V7_i + V9_i;
npy_int64 V13_tmp2;
V13_tmp2 = V3_i ? V13_tmp1 : V5_i;
npy_int64 V13_tmp3;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5_executor(__struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5* self) {
            return self->run();
        }

        static void __struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5* struct_ptr = new __struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5_executor), struct_ptr, __struct_compiled_op_b3d4a7e00ec67e76994f4a5cba8481b5_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb3d4a7e00ec67e76994f4a5cba8481b5(void){
   import_array();
   (void) Py_InitModule("b3d4a7e00ec67e76994f4a5cba8481b5", MyMethods);
}
