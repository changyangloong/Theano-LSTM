...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d() {}
        ~__struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_17;}
                ...
                V13_jumpx_2 = -(0);
                //printf("V13_jumpx_2 is:");
                //std::cout << V13_jumpx_2 << std::endl;
        ...
        goto __label_17;}
                ...
                V15_jumpx_2 = -(0);
                //printf("V15_jumpx_2 is:");
                //std::cout << V15_jumpx_2 << std::endl;
            ...
            
{
    ...
    int init_totals[3] = {1, V5_n1, V5_n2};
...
0, V15_stride1, 0
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V11_stride_l2 = init_strides[4][V5_loops_rit->second];
            ++V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V13_stride_l2 = init_strides[5][V5_loops_rit->second];
            ++V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V15_stride_l2 = init_strides[6][V5_loops_rit->second];
            ++V5_loops_rit;
...
npy_int8 &V9_i = * ( V9_iter+V9_stride_l2*ITER_2+V9_stride_l1*ITER_1+V9_stride_l0*ITER_0);
...
V17_tmp1 = V3_i ? V13_i : V7_i;
npy_float32 V17_tmp2;
V17_tmp2 = V5_i * V7_i;
npy_float32 V17_tmp3;
V17_tmp3 = V11_i * V17_tmp1;
npy_float32 V17_tmp4;
V17_tmp4 = V3_i ? V17_tmp2 : V9_i;
npy_float32 V17_tmp5;
V17_tmp5 = V17_tmp4 + V17_tmp3;
V1_i = V17_tmp5 / V15_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d_executor(__struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d* self) {
            return self->run();
        }

        static void __struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d* struct_ptr = new __struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d_executor), struct_ptr, __struct_compiled_op_a51c1a6070f9d968d4d5ad2a4ec4de9d_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita51c1a6070f9d968d4d5ad2a4ec4de9d(void){
   import_array();
   (void) Py_InitModule("a51c1a6070f9d968d4d5ad2a4ec4de9d", MyMethods);
}
