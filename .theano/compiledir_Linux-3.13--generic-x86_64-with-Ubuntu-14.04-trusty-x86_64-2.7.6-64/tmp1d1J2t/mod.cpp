...
#define THEANO_MACRO_MOD(x,y) (x % y)
    ...
    namespace {
    struct __struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee() {}
        ~__struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee(void) {
            cleanup();
        }
...
if (V7_i < 0) {
    if (V5_i < 0) {
        V13_0_tmp1 = ((-V7_i) / (-V5_i));
    } else {
        V13_0_tmp1 = - ((-V7_i) / V5_i) - ((THEANO_MACRO_MOD((-V7_i), V5_i) == 0) ? 0 : 1);
    }
} else {
    if (V5_i < 0) {
        V13_0_tmp1 = - (V7_i / (-V5_i)) - ((THEANO_MACRO_MOD(V7_i, (-V5_i)) == 0) ? 0 : 1);
...
npy_int64 V13_1_tmp2;
V13_1_tmp2 = V13_1_tmp1 ? V9_i : V13_tmp1;
V13_tmp2 = V3_i - V13_1_tmp2;
}
...
V13_tmp3 = V13_2_tmp1 ? V7_i : V13_tmp2;
}
...
npy_int8 V13_tmp5;
V13_tmp5 = (V13_tmp4 < V11_i);
V1_i = V13_tmp5 ? V13_tmp4 : V11_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee_executor(__struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee* self) {
            return self->run();
        }

        static void __struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee* struct_ptr = new __struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee_executor), struct_ptr, __struct_compiled_op_cf2059bf30da726ae70ebc682582b6ee_destructor);
  return thunk; }
...
PyMODINIT_FUNC initcf2059bf30da726ae70ebc682582b6ee(void){
   import_array();
   (void) Py_InitModule("cf2059bf30da726ae70ebc682582b6ee", MyMethods);
}
