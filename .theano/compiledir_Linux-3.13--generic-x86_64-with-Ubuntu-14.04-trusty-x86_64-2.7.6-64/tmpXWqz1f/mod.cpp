...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a() {}
        ~__struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a(void) {
            cleanup();
        }
...
// Op class MaxAndArgmax
        ...
        V7 = (PyArrayObject*)PyArray_Max(V3, axis, NULL);
        if(V7 == NULL){
        ...
        if(!PyArray_CheckExact(V7)){
            V7 = (PyArrayObject*)PyArray_FromAny((PyObject*)V7, NULL, 0, 0, NPY_ARRAY_ENSUREARRAY, NULL);
            if(V7 == NULL){
                {
        __failure = 9;
        if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a_executor(__struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a* self) {
            return self->run();
        }

        static void __struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a* struct_ptr = new __struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a_executor), struct_ptr, __struct_compiled_op_d993bb1ecf8c41a45f399da3bf47be8a_destructor);
  return thunk; }
...
PyMODINIT_FUNC initd993bb1ecf8c41a45f399da3bf47be8a(void){
   import_array();
   (void) Py_InitModule("d993bb1ecf8c41a45f399da3bf47be8a", MyMethods);
}
