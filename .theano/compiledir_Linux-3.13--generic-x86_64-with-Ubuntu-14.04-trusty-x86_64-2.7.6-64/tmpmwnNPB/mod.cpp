...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_01f240867aa175800887c99fa27a6b30 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_01f240867aa175800887c99fa27a6b30() {}
        ~__struct_compiled_op_01f240867aa175800887c99fa27a6b30(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_01f240867aa175800887c99fa27a6b30_executor(__struct_compiled_op_01f240867aa175800887c99fa27a6b30* self) {
            return self->run();
        }

        static void __struct_compiled_op_01f240867aa175800887c99fa27a6b30_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_01f240867aa175800887c99fa27a6b30*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_01f240867aa175800887c99fa27a6b30* struct_ptr = new __struct_compiled_op_01f240867aa175800887c99fa27a6b30();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_01f240867aa175800887c99fa27a6b30_executor), struct_ptr, __struct_compiled_op_01f240867aa175800887c99fa27a6b30_destructor);
  return thunk; }
...
PyMODINIT_FUNC init01f240867aa175800887c99fa27a6b30(void){
   import_array();
   (void) Py_InitModule("01f240867aa175800887c99fa27a6b30", MyMethods);
}
