...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462() {}
        ~__struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462(void) {
            cleanup();
        }
...
dims[1] = V5_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V13));
        }
        else {
...
V15_tmp3 = V9_i < -88.0f ? 0.0 : V9_i > 15.0f ? 1.0f : 1.0f /(1.0f + exp(-V9_i));
npy_float32 V15_tmp4;
V15_tmp4 = V5_i < -88.0f ? 0.0 : V5_i > 15.0f ? 1.0f : 1.0f /(1.0f + exp(-V5_i));
npy_float32 V15_tmp5;
V15_tmp5 = V15_tmp3 * V15_tmp2;
npy_float32 V15_tmp6;
V15_tmp6 = V15_tmp4 * V7_i;
npy_float32 V15_tmp7;
V15_tmp7 = V15_tmp6 + V15_tmp5;
npy_float32 V15_tmp8;
V15_tmp8 = V3_i * V15_tmp7;
V1_i = V15_tmp8 + V15_tmp1;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462_executor(__struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462* self) {
            return self->run();
        }

        static void __struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462* struct_ptr = new __struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462_executor), struct_ptr, __struct_compiled_op_7a12eab95c7525e7e5f99121dfc97462_destructor);
  return thunk; }
...
PyMODINIT_FUNC init7a12eab95c7525e7e5f99121dfc97462(void){
   import_array();
   (void) Py_InitModule("7a12eab95c7525e7e5f99121dfc97462", MyMethods);
}
