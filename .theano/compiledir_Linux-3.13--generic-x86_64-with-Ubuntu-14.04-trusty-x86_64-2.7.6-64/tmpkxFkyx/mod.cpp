...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc() {}
        ~__struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc_executor(__struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc* self) {
            return self->run();
        }

        static void __struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc* struct_ptr = new __struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc_executor), struct_ptr, __struct_compiled_op_952842abbda77f65cb4aaca7147a8fcc_destructor);
  return thunk; }
...
PyMODINIT_FUNC init952842abbda77f65cb4aaca7147a8fcc(void){
   import_array();
   (void) Py_InitModule("952842abbda77f65cb4aaca7147a8fcc", MyMethods);
}
