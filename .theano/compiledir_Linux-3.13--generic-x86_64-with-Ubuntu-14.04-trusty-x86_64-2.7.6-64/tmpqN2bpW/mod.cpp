...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b6af90bbbfd1b7f2f7d091f2c9bee542 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b6af90bbbfd1b7f2f7d091f2c9bee542() {}
        ~__struct_compiled_op_b6af90bbbfd1b7f2f7d091f2c9bee542(void) {
            cleanup();
        }
...
;
    ...
    int init_totals[3] = {V5_n0, V5_n1, V5_n2};
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b6af90bbbfd1b7f2f7d091f2c9bee542_executor(__struct_compiled_op_b6af90bbbfd1b7f2f7d091f2c9bee542* self) {
            return self->run();
        }

        static void __struct_compiled_op_b6af90bbbfd1b7f2f7d091f2c9bee542_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b6af90bbbfd1b7f2f7d091f2c9bee542*)self);
        }
...
PyMODINIT_FUNC initb6af90bbbfd1b7f2f7d091f2c9bee542(void){
   import_array();
   (void) Py_InitModule("b6af90bbbfd1b7f2f7d091f2c9bee542", MyMethods);
}
