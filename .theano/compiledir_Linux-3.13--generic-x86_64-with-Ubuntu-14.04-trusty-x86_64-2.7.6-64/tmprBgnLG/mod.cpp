...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_4bfdb43bd56b6880adc654c58104619b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4bfdb43bd56b6880adc654c58104619b() {}
        ~__struct_compiled_op_4bfdb43bd56b6880adc654c58104619b(void) {
            cleanup();
        }
...
// Op class Sum
        ...
        goto __label_5;}
                ...
                //printf("V3_jump1_2 is:");
                //std::cout << V3_jump1_2 << std::endl;
                
                V3_n0 = PyArray_DIMS(V3)[0];
                V3_stride0 = PyArray_STRIDES(V3)[0] / sizeof(npy_float32);
                V3_jump0_1 = (V3_stride0) - (V3_n1*V3_stride1);
                ...
                V3_jump2_0 = (V3_stride2) - (V3_n0*V3_stride0);
                //printf("V3_jump2_0 is:");
                //std::cout << V3_jump2_0 << std::endl;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4bfdb43bd56b6880adc654c58104619b_executor(__struct_compiled_op_4bfdb43bd56b6880adc654c58104619b* self) {
            return self->run();
        }

        static void __struct_compiled_op_4bfdb43bd56b6880adc654c58104619b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4bfdb43bd56b6880adc654c58104619b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4bfdb43bd56b6880adc654c58104619b* struct_ptr = new __struct_compiled_op_4bfdb43bd56b6880adc654c58104619b();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4bfdb43bd56b6880adc654c58104619b_executor), struct_ptr, __struct_compiled_op_4bfdb43bd56b6880adc654c58104619b_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4bfdb43bd56b6880adc654c58104619b(void){
   import_array();
   (void) Py_InitModule("4bfdb43bd56b6880adc654c58104619b", MyMethods);
}
