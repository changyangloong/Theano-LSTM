...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_257b914853fba60504381f83e05a8722 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_257b914853fba60504381f83e05a8722() {}
        ~__struct_compiled_op_257b914853fba60504381f83e05a8722(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_257b914853fba60504381f83e05a8722_executor(__struct_compiled_op_257b914853fba60504381f83e05a8722* self) {
            return self->run();
        }

        static void __struct_compiled_op_257b914853fba60504381f83e05a8722_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_257b914853fba60504381f83e05a8722*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_257b914853fba60504381f83e05a8722* struct_ptr = new __struct_compiled_op_257b914853fba60504381f83e05a8722();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_257b914853fba60504381f83e05a8722_executor), struct_ptr, __struct_compiled_op_257b914853fba60504381f83e05a8722_destructor);
  return thunk; }
...
PyMODINIT_FUNC init257b914853fba60504381f83e05a8722(void){
   import_array();
   (void) Py_InitModule("257b914853fba60504381f83e05a8722", MyMethods);
}
