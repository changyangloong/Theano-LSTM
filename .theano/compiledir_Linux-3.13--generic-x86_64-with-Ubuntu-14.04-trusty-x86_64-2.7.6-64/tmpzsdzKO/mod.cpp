...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6() {}
        ~__struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6(void) {
            cleanup();
        }
...
V11_tmp3 = sqrt(V11_tmp1);
npy_float32 V11_tmp4;
V11_tmp4 = sqrt(V11_tmp2);
npy_float32 V11_tmp5;
V11_tmp5 = -V11_tmp4;
npy_float32 V11_tmp6;
V11_tmp6 = V11_tmp5 / V11_tmp3;
V1_i = V11_tmp6 * V9_i;
}
;
                    }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6_executor(__struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6* self) {
            return self->run();
        }

        static void __struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6* struct_ptr = new __struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6_executor), struct_ptr, __struct_compiled_op_bbee6b20eb10784c33e373ed37a12ee6_destructor);
  return thunk; }
...
PyMODINIT_FUNC initbbee6b20eb10784c33e373ed37a12ee6(void){
   import_array();
   (void) Py_InitModule("bbee6b20eb10784c33e373ed37a12ee6", MyMethods);
}
