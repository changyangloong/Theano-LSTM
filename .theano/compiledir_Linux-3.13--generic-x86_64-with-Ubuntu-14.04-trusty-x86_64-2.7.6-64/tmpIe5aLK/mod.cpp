...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a807aa024efa995796df425fdab9b9e0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a807aa024efa995796df425fdab9b9e0() {}
        ~__struct_compiled_op_a807aa024efa995796df425fdab9b9e0(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a807aa024efa995796df425fdab9b9e0_executor(__struct_compiled_op_a807aa024efa995796df425fdab9b9e0* self) {
            return self->run();
        }

        static void __struct_compiled_op_a807aa024efa995796df425fdab9b9e0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a807aa024efa995796df425fdab9b9e0*)self);
        }
...
PyMODINIT_FUNC inita807aa024efa995796df425fdab9b9e0(void){
   import_array();
   (void) Py_InitModule("a807aa024efa995796df425fdab9b9e0", MyMethods);
}
