...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_de268f2a24f35d43273101208dda7d7e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_de268f2a24f35d43273101208dda7d7e() {}
        ~__struct_compiled_op_de268f2a24f35d43273101208dda7d7e(void) {
            cleanup();
        }
...
V19_tmp1 = V7_i - V9_i;
npy_int64 V19_tmp2;
V19_tmp2 = V15_i + V17_i;
npy_int8 V19_tmp3;
V19_tmp3 = (V11_i > V5_i);
npy_int8 V19_tmp4;
V19_tmp4 = (V19_tmp1 < V5_i);
npy_int64 V19_tmp5;
V19_tmp5 = ((V19_tmp1)>(V19_tmp2)? (V19_tmp1): ((V19_tmp2)>=(V19_tmp1)? (V19_tmp2): nan("")));
npy_int8 V19_tmp6;
V19_tmp6 = (V19_tmp4 & V19_tmp3);
npy_int64 V19_tmp7;
V19_tmp7 = V19_tmp6 ? V13_i : V19_tmp5;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_de268f2a24f35d43273101208dda7d7e_executor(__struct_compiled_op_de268f2a24f35d43273101208dda7d7e* self) {
            return self->run();
        }

        static void __struct_compiled_op_de268f2a24f35d43273101208dda7d7e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_de268f2a24f35d43273101208dda7d7e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_de268f2a24f35d43273101208dda7d7e* struct_ptr = new __struct_compiled_op_de268f2a24f35d43273101208dda7d7e();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_de268f2a24f35d43273101208dda7d7e_executor), struct_ptr, __struct_compiled_op_de268f2a24f35d43273101208dda7d7e_destructor);
  return thunk; }
...
PyMODINIT_FUNC initde268f2a24f35d43273101208dda7d7e(void){
   import_array();
   (void) Py_InitModule("de268f2a24f35d43273101208dda7d7e", MyMethods);
}
