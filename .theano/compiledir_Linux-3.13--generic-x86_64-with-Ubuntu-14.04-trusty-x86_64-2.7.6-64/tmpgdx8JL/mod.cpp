...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_dac91eaec68766db616c7869a349a679 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_dac91eaec68766db616c7869a349a679() {}
        ~__struct_compiled_op_dac91eaec68766db616c7869a349a679(void) {
            cleanup();
        }
...
subtensor_spec[2] = 9223372036854775806;;
        ...
        goto __label_9;};
                ...
                xview_offset += PyArray_STRIDES(V1)[outer_ii] * start *
                       1;
                xview_dims[inner_ii] = slicelength;
                xview_strides[inner_ii] = PyArray_STRIDES(V1)[outer_ii] * step;
            ...
            else // tuple coord `outer_ii` is an int
            {
                ...
                if (idx >= 0)
                {
                    ...
                    {
                        xview_offset += PyArray_STRIDES(V1)[outer_ii] * idx *
                               1;
                    }
                    else
                    {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_dac91eaec68766db616c7869a349a679_executor(__struct_compiled_op_dac91eaec68766db616c7869a349a679* self) {
            return self->run();
        }

        static void __struct_compiled_op_dac91eaec68766db616c7869a349a679_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_dac91eaec68766db616c7869a349a679*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_dac91eaec68766db616c7869a349a679* struct_ptr = new __struct_compiled_op_dac91eaec68766db616c7869a349a679();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_dac91eaec68766db616c7869a349a679_executor), struct_ptr, __struct_compiled_op_dac91eaec68766db616c7869a349a679_destructor);
  return thunk; }
...
PyMODINIT_FUNC initdac91eaec68766db616c7869a349a679(void){
   import_array();
   (void) Py_InitModule("dac91eaec68766db616c7869a349a679", MyMethods);
}
