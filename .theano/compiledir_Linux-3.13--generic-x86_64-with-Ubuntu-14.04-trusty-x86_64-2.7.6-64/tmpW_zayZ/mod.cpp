...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ddde6ae9a09770eed554831e9a1050c2 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_ddde6ae9a09770eed554831e9a1050c2() {}
        ~__struct_compiled_op_ddde6ae9a09770eed554831e9a1050c2(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ddde6ae9a09770eed554831e9a1050c2_executor(__struct_compiled_op_ddde6ae9a09770eed554831e9a1050c2* self) {
            return self->run();
        }

        static void __struct_compiled_op_ddde6ae9a09770eed554831e9a1050c2_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_ddde6ae9a09770eed554831e9a1050c2*)self);
        }
...
PyMODINIT_FUNC initddde6ae9a09770eed554831e9a1050c2(void){
   import_array();
   (void) Py_InitModule("ddde6ae9a09770eed554831e9a1050c2", MyMethods);
}
