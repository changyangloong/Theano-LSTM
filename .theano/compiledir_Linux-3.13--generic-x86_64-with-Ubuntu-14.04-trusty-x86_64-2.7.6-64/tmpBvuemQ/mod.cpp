...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_4dd272886be3befa8227cc83022e1cc0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4dd272886be3befa8227cc83022e1cc0() {}
        ~__struct_compiled_op_4dd272886be3befa8227cc83022e1cc0(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4dd272886be3befa8227cc83022e1cc0_executor(__struct_compiled_op_4dd272886be3befa8227cc83022e1cc0* self) {
            return self->run();
        }

        static void __struct_compiled_op_4dd272886be3befa8227cc83022e1cc0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4dd272886be3befa8227cc83022e1cc0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4dd272886be3befa8227cc83022e1cc0* struct_ptr = new __struct_compiled_op_4dd272886be3befa8227cc83022e1cc0();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4dd272886be3befa8227cc83022e1cc0_executor), struct_ptr, __struct_compiled_op_4dd272886be3befa8227cc83022e1cc0_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4dd272886be3befa8227cc83022e1cc0(void){
   import_array();
   (void) Py_InitModule("4dd272886be3befa8227cc83022e1cc0", MyMethods);
}
