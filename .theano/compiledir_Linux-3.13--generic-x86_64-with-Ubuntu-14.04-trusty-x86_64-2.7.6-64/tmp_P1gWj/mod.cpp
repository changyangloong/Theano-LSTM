...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0() {}
        ~__struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0(void) {
            cleanup();
        }
...
V11_tmp1 = (V3_i < V5_i);
npy_int64 V11_tmp2;
V11_tmp2 = V11_tmp1 ? V3_i : V5_i;
npy_int64 V11_tmp3;
V11_tmp3 = V11_tmp2 - V7_i;
npy_int64 V11_tmp4;
V11_tmp4 = V11_tmp3 - V3_i;
V1_i = V11_tmp4 + V9_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0_executor(__struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0* self) {
            return self->run();
        }

        static void __struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0* struct_ptr = new __struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0_executor), struct_ptr, __struct_compiled_op_c6db0aeb4bd8851c5cd19969f8ab49a0_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc6db0aeb4bd8851c5cd19969f8ab49a0(void){
   import_array();
   (void) Py_InitModule("c6db0aeb4bd8851c5cd19969f8ab49a0", MyMethods);
}
