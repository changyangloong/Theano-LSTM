...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_4bdcf784547be536acb2db618a6666ca {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_4bdcf784547be536acb2db618a6666ca() {}
        ~__struct_compiled_op_4bdcf784547be536acb2db618a6666ca(void) {
            cleanup();
        }
...
npy_int64& V11_i = *V11_iter;
                  ...
                  {
npy_int64 V13_tmp1;
V13_tmp1 = ((V5_i)>(V3_i)? (V5_i): ((V3_i)>=(V5_i)? (V3_i): nan("")));
npy_int8 V13_tmp2;
V13_tmp2 = (V13_tmp1 < V11_i);
npy_int64 V13_tmp3;
V13_tmp3 = V13_tmp1 + V5_i + V9_i;
npy_int8 V13_tmp4;
V13_tmp4 = (V13_tmp1 < V7_i);
npy_int64 V13_tmp5;
V13_tmp5 = V13_tmp2 ? V13_tmp1 : V11_i;
npy_int8 V13_tmp6;
V13_tmp6 = (V13_tmp3 < V7_i);
npy_int64 V13_tmp7;
V13_tmp7 = V13_tmp6 ? V7_i : V13_tmp3;
npy_int64 V13_tmp8;
V13_tmp8 = V13_tmp4 ? V13_tmp7 : V13_tmp5;
V1_i = V13_tmp8 - V7_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_4bdcf784547be536acb2db618a6666ca_executor(__struct_compiled_op_4bdcf784547be536acb2db618a6666ca* self) {
            return self->run();
        }

        static void __struct_compiled_op_4bdcf784547be536acb2db618a6666ca_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_4bdcf784547be536acb2db618a6666ca*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_4bdcf784547be536acb2db618a6666ca* struct_ptr = new __struct_compiled_op_4bdcf784547be536acb2db618a6666ca();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_4bdcf784547be536acb2db618a6666ca_executor), struct_ptr, __struct_compiled_op_4bdcf784547be536acb2db618a6666ca_destructor);
  return thunk; }
...
PyMODINIT_FUNC init4bdcf784547be536acb2db618a6666ca(void){
   import_array();
   (void) Py_InitModule("4bdcf784547be536acb2db618a6666ca", MyMethods);
}
