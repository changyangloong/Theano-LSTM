...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_0e1fba492183948727ba5e62dc308d3e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_0e1fba492183948727ba5e62dc308d3e() {}
        ~__struct_compiled_op_0e1fba492183948727ba5e62dc308d3e(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_0e1fba492183948727ba5e62dc308d3e_executor(__struct_compiled_op_0e1fba492183948727ba5e62dc308d3e* self) {
            return self->run();
        }

        static void __struct_compiled_op_0e1fba492183948727ba5e62dc308d3e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_0e1fba492183948727ba5e62dc308d3e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_0e1fba492183948727ba5e62dc308d3e* struct_ptr = new __struct_compiled_op_0e1fba492183948727ba5e62dc308d3e();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_0e1fba492183948727ba5e62dc308d3e_executor), struct_ptr, __struct_compiled_op_0e1fba492183948727ba5e62dc308d3e_destructor);
  return thunk; }
...
PyMODINIT_FUNC init0e1fba492183948727ba5e62dc308d3e(void){
   import_array();
   (void) Py_InitModule("0e1fba492183948727ba5e62dc308d3e", MyMethods);
}
